...
export declare function queryOptions(value: number[] | Uint8Array, index: number, metadataContext?: any): Lexer.Token;
export declare function queryOption(value: number[] | Uint8Array, index: number, metadataContext?: any): Lexer.Token;
export declare function systemQueryOption(value: number[] | Uint8Array, index: number, metadataContext?: any): Lexer.Token;
export declare function id(value: number[] | Uint8Array, index: number): Lexer.Token;
export declare function expand(value: number[] | Uint8Array, index: number, metadataContext?: any): Lexer.Token;
export declare function expandItem(value: number[] | Uint8Array, index: number, metadataContext?: any): Lexer.Token;
...
export declare function expandPath(value: number[] | Uint8Array, index: number, metadataContext?: any): Lexer.Token;
